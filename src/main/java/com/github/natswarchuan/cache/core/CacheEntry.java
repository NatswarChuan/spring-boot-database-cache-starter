...
/**
 * Entity JPA đại diện cho một mục cache được lưu trong cơ sở dữ liệu. Tên bảng có thể được cấu hình
 * thông qua thuộc tính "com.github.natswarchuan.cache.table-name" trong application.properties. Mặc
 * định là "app_cache_entries".
 */
@Entity
@Table(
